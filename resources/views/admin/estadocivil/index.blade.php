...
<div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Estado civil</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Listado de los estados civiles
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="col-lg-12">
      <div class="card card-line-primary">
            <div class="card-header">
              <h4 class="card-title">Listado de los países</h4>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    @foreach ($academias as $element)
                      <tr>
                       ...
                       @include('admin.estadocivil.partials.modal.edit')
                    @endforeach
                  </tbody>
                </table>
            </div>
  ...
  @include('admin.estadocivil.partials.modal.create')
