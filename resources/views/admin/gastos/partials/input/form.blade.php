@php
  $estados = App\Models\TipoGasto::pluck('name','id');
...
<div class="row">
   <div class="col-4">
    <label>Tipo de ofrenda: </label>
     <div class="input-group input-group-merge mb-2">
      ...
      {!! Form::select('tipo_gasto_id', $estados, null, ['class' => 'form-control ']) !!}
     </div>
 </div>
 <div class="col-4">
 ...
 <div class="col-4">
    <label>Cantidad del gasto efectuado: </label>
     <div class="input-group input-group-merge mb-2">
   ...
   <div class="col-12">
       <label for="textarea-counter">Descripción del gasto</label>
 ...
 <div class="col-12 text-center">
    <label class="font-weight-bolder" for="status">Estado del gasto</label>
