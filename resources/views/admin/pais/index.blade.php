...
<div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Países</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Listado de los países
                        </li>
                    </ol>
                </div>
            </div>
                  ...
                  <tbody>
                    @foreach ($academias as $element)
                      <tr>
                       ...
                       @include('admin.pais.partials.modal.edit')
                    @endforeach
                  </tbody>
                </table>
            </div>
  ...
  @include('admin.pais.partials.modal.create')
@endsection
