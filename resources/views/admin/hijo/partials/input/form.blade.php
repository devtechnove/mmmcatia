  ...
  <div class="col-4">
    ...
    <label>Fecha de nacimiento: </label>
     <div class="input-group input-group-merge mb-2">
       ...
       {!! Form::text('fecha_nacimiento',null,['class'=>'datepicker-here form-control digits', 'required' => 'required','autocomplete' =>'off','placeholder' =>'YYYY-MM-DD','data-language' => 'en']) !!}
...
<div class="col-6 mt-2">
    <label class="red-text">Si el hijo (a) es bautizado o no: </label>
     <div class="input-group input-group-merge mb-2">
...
<div class="col-4 mt-2">
    <label>Año de ingreso a la congregación: </label>
     <div class="input-group input-group-merge mb-2">
       ...
       <input type="text" name ="ano_ingreso" value="{{ date('Y') }}" class="form-control">
    </div>
  </div>
