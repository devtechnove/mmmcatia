...
class AdminTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sociedades->name       = 'DAMAS';
        $sociedades->status    = 1;
        $sociedades->save();

        $sociedades =new Sociedades();
        $sociedades->name       = 'CABALLEROS';
        $sociedades->status    = 1;
        $sociedades->save();


        $sociedades =new Sociedades();
        $sociedades->name       = 'JÓVENES';
        $sociedades->status    = 1;
        $sociedades->save();

        $sociedades =new Sociedades();
        $sociedades->name       = 'ESCUELA DOMINICAL DE NIÑOS';
        $sociedades->status    = 1;
        $sociedades->save();

        $sociedades =new Sociedades();
        $sociedades->name       = 'ADOLESCENTES';
        $sociedades->status    = 1;
        $sociedades->save();
        ...
        $user =new User();
        $user->name = 'Ricardo';
        $user->lastname = 'Manrique';
        $user->username = 'rmanrique';
        $user->email = 'rmanrique@mail.com';
        $user->email_verified_at = now();
        $user->password = bcrypt('rmanrique2021');
        $user->status = 1;
        $user->genero = 1;
        $user->foto = 'user-male.png';
        $user->save();
        ...
        $user =new User();
        $user->name = 'Eumi';
        $user->lastname = 'Campomas';
        $user->username = 'ecampomas';
        $user->email = 'ecampomas@mail.com';
        $user->email_verified_at = now();
        $user->password = bcrypt('ecampomas2021');
        $user->status = 1;
        $user->genero = 1;
        $user->foto = 'user-male.png';
        $user->save();
        ...
        $user =new User();
        $user->name = 'Yervin';
        $user->lastname = 'Hernández';
        $user->username = 'yhernandez';
        $user->email = 'yhernandez@mail.com';
        $user->email_verified_at = now();
        $user->password = bcrypt('yhernandez');
        $user->status = 1;
        $user->sociedad_id = 3;
        $user->genero = 1;
        $user->foto = 'user-male.png';
        ...
        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Líder de Damas';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();

        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Líder de Caballeros';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();

        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Líder de Jóvenes';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();

        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Líder de los Adolescentes';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();

        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Líder del instituto de idiomas';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();
        ...
        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Líder de los campos blancos';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();

        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Líder de los diáconos';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();

        $liderazgo =new TipoLider();
        $liderazgo->name       = 'Colaboradores';
        $liderazgo->status    = 1;
        $liderazgo->user_id = 1;
        $liderazgo->save();
        ...
        $iglesia =new Iglesia();
        $iglesia->name       = 'MMM-CATIA';
        $iglesia->direccion  = 'Caracas - Venezuela';
        $iglesia->telefono   = '+58 000-0000000';
        $iglesia->email      = 'correo@mail.com';
        $iglesia->logo       = 'logo-principal.png';
        $iglesia->user_id    = 1;
        $iglesia->save();
        ...
        $aporte =new TipoAporte();
        $aporte->name       = 'APORTES ESPECIALES';
        $aporte->status    = 1;
        $aporte->user_id    = 1;
        $aporte->save();


        $aporte =new DiaServicio();
        $aporte->name           = 'SERVICIO DE ORACIÓN';
        $aporte->dia_servicio   = 'LUNES';
        $aporte->hora_inicio_servicio = '06:00 PM';
        $aporte->hora_fin_servicio = '07:00 PM';
        $aporte->status    = 1;
        $aporte->user_id    = 1;
        $aporte->save(); 

        $aporte =new DiaServicio();
        $aporte->name           = 'SERVICIO DE ESTUDIO BÍBLICO';
        $aporte->dia_servicio   = 'MARTES';
        $aporte->hora_inicio_servicio = '06:00 PM';
        $aporte->hora_fin_servicio = '07:00 PM';
        $aporte->status    = 1;
        $aporte->user_id    = 1;
        ...
        $aporte =new DiaServicio();
        $aporte->name           = 'AYUNO';
        $aporte->dia_servicio   = 'MIÉRCOLES';
        $aporte->hora_inicio_servicio = '08:00 AM';
        $aporte->hora_fin_servicio = '04:00 PM';
        $aporte->status    = 1;
        $aporte->user_id    = 1;
        $aporte->save();
        ...
        $aporte =new DiaServicio();
        $aporte->name           = 'SERVICIO DE ESCUELA DOMINICAL 1ER SERVICIO';
        $aporte->dia_servicio   = 'DOMINGO';
        $aporte->hora_inicio_servicio = '08:00 AM';
        $aporte->hora_fin_servicio = '10:30 AM';
        $aporte->status    = 1;
        $aporte->user_id    = 1;
        $aporte->save();
        ...
        $aporte =new DiaServicio();
        $aporte->name           = 'SERVICIO DE ESCUELA DOMINICAL 2DO SERVICIO';
        $aporte->dia_servicio   = 'DOMINGO';
        $aporte->hora_inicio_servicio = '11:00 AM';
        $aporte->hora_fin_servicio = '01:00 PM';
        $aporte->status    = 1;
        $aporte->user_id    = 1;
        $aporte->save();
        ...
        $cargo =new Cargo();
        $cargo->name       = 'VICE-PRESDENTE(A)';
        $cargo->user_id    = 1;
        $cargo->status    = 1;
        $cargo->save();

        $cargo =new Cargo();
        $cargo->name       = 'SECRETARIO(A)';
        $cargo->user_id    = 1;
        $cargo->status    = 1;
        $cargo->save();

        $cargo =new Cargo();
        $cargo->name       = 'TESORERO(A)';
        $cargo->user_id    = 1;
        $cargo->status    = 1;
        $cargo->save();
    ...
    $tipoG =new TipoGasto();
    $tipoG->name       = 'Reparaciones';
    $tipoG->status    = 1;
    $tipoG->save();


    $tipoG =new TipoGasto();
    $tipoG->name       = 'Mantenimiento de Local';
    $tipoG->status    = 1;
    $tipoG->save();

    $tipoG =new TipoGasto();
    $tipoG->name       = 'Reparación de equipos de sonido';
    $tipoG->status    = 1;
    $tipoG->save();


    $tipoG =new TipoGasto();
    $tipoG->name       = 'Servicios públicos';
    $tipoG->status    = 1;
    $tipoG->save();


    $tipoG =new TipoGasto();
    $tipoG->name       = 'Alquiler Casa minionera';
    $tipoG->status    = 1;
    $tipoG->save();


    $tipoG =new TipoGasto();
    $tipoG->name       = 'Alquiler de local de culto';
    $tipoG->status    = 1;
    $tipoG->save();


    $tipoG =new TipoGasto();
    $tipoG->name       = 'Útiles de limpieza';
    $tipoG->status    = 1;
    $tipoG->save();

    $tipoG =new TipoGasto();
    $tipoG->name       = 'Gastos de medicinas';
    $tipoG->status    = 1;
    $tipoG->save();
